...
export function HeaderLogo() {
  return (
    <Link
      href="/"
      aria-label="remocn"
      className="flex items-baseline text-lg font-semibold tracking-tight text-foreground focus-visible:outline-none"
    >
      <svg
        viewBox="0 0 124.06 134.26"
        aria-hidden="true"
        className="h-[0.76em] w-auto"
      >
        <path
          fill="currentColor"
      ...
      <span className="ml-[0.04em]">emocn</span>
    </Link>
  );
}
