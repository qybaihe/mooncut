...
export const sharedBitInventory = [
  {
    "exportName": "BasicCounter",
    "id": "bit-basic-counter",
    "name": "Basic Counter",
...
] as const satisfies readonly SharedBitInventoryEntry[];
